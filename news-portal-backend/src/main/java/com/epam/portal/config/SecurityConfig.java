...
//
//        // secures all REST endpoints under "/api/news"
//        // and adds following security authorizations
//        //
//        // EMPLOYEE role can perform following
//        // 1. Get a list of all news.  GET /api/news
//        // 2. Get a single news.  GET /api/news/{newsId}
//
//        //
//        // MANAGER role can perform following
//        // 1. Add a new news.  POST /api/news
//        // 2. Update an existing news.  PUT /api/news
//        //
//
//        //
//        // ADMIN role can perform following
//        // 1. Delete a news.  DELETE /api/news/{news}
//        //
//        //        This only allows access to the given endpoints based on the role. The use of “**”
//        //        makes sure to secure endpoints if user enters additional information at the end of
//        //        the URL.
//
//
